-- Script para adicionar campo "Edição Manual Campos" na tabela Orçamento
-- Data: 16/09/2025
-- Descrição: Campo para controlar se o usuário pode editar manualmente todos os campos do grid
